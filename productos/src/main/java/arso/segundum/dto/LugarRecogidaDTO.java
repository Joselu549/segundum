...
public class LugarRecogidaDTO {
    ...
    @Schema(description = "Longitud en grados de la posición del lugar", example = "56.89764", minimum = "-180.0", maximum = "180.0")
    @NotNull(message = "La longitud del lugar es obligatoria")
    @DecimalMin("-180.0")
    @DecimalMax("180.0")
    private Double longitud;

    @Schema(description = "Latitud en grados de la posición del lugar", example = "56.89764", minimum = "-90.0", maximum = "90.0")
    @NotNull(message = "La latitud del lugar es obligatoria")
    @DecimalMin("-90.0")
    @DecimalMax("90.0")
